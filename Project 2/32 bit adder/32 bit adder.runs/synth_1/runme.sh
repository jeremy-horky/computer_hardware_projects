...
HD_PWD='C:/Users/horku/Documents/School/EECE/COEN 4710/computer_hardware_projects/Project 2/32 bit adder/32 bit adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder32Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder32Bit.tcl
