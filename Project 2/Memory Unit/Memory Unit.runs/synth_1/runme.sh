...
HD_PWD='C:/Users/horku/Documents/School/EECE/COEN 4710/computer_hardware_projects/Project 2/Memory Unit/Memory Unit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_unit.tcl
