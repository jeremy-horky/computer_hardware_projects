...
HD_PWD='C:/Users/horku/Documents/School/EECE/COEN 4710/computer_hardware_projects/Project 2/ALU_Control/ALU_Control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_Control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_Control.tcl
